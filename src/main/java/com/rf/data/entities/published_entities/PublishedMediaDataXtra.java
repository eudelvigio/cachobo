...
/**
 * Esta entidad almacena los publishedMediaDataXtras generados al publicar un Media
 * @author mortas
 */
@Entity
@Audited
...
@DynamicUpdate
public class PublishedMediaDataXtra {
    ...
    @ManyToOne
    @JsonIgnore
    private PublishedMediaData mediaData;
    ...
    @JsonIgnore
    public PublishedMediaData getMediaData() {
        return mediaData;
    }
    ...
    public void setMediaData(PublishedMediaData mediaData) {
