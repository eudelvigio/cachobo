 ...
 * @author mortas
 */
public interface PageMetadataRepository extends CrudRepository<PageMetadata, Integer> {

    List<PageMetadata> findByPage(Page page);

    List<PageMetadata> findByKeyAndValue(EnumMetadata key, String value);
